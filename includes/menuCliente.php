...
<div class="list-group shadow-sm">
  ...
  <a href="/grafica_web/cliente/minhasEncomendas.php" class="list-group-item list-group-item-action <?= ($pagina_atual == 'minhas_encomendas.php') ? 'active' : '' ?>">
    Minhas Encomendas
  </a>

  <a href="/grafica_web/cliente/meusDados.php" class="list-group-item list-group-item-action <?= ($pagina_atual == 'meus_dados.php') ? 'active' : '' ?>">
    Meus Dados
  </a>
