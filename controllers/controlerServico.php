...
switch ($opcao) {
    case 'cadastrar':
        ...
        if ($servicoDao->criar($novoServico)) {
            header('Location: ../admin/gerenciarServicos.php?status=sucesso&acao=cadastrado');
        } else {
            header('Location: ../admin/gerenciarServicos.php?status=erro&acao=cadastro');
        }
        break;
    ...
    case 'alterar':
        ...
        if ($servicoDao->atualizar($servicoAlterar)) {
            header('Location: ../admin/gerenciarServicos.php?status=sucesso&acao=alterado');
        } else {
            header('Location: ../admin/gerenciarServicos.php?status=erro&acao=alteracao');
        }
        break;
    ...
    case 'excluir':
        ...
        if ($servicoDao->excluir($id)) {
            header('Location: ../admin/gerenciarServicos.php?status=sucesso&acao=excluido');
        } else {
            header('Location: ../admin/gerenciarServicos.php?status=erro&acao=exclusao');
        }
        break;
    
    case 'listar':
    default:
    header('Location: ../admin/gerenciarServicos.php');
        break;
}
?>