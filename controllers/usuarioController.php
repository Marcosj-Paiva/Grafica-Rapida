    ...
    header('Location: ../admin/gerenciarClientes.php');
        ...
        case 'atualizar_meus_dados':
            ...
            if (empty($nome) || empty($email)) {
                header('Location: /grafica_web/cliente/meusDados.php?status=erro&acao=dados_invalidos');
                exit();
            }
    
            $usuario = $usuarioDao->buscarPorId($id);
            if (!$usuario) {
                header('Location: /grafica_web/cliente/meusDados.php?status=erro&acao=usuario_nao_encontrado');
                exit();
            }
            ...
            if ($sucessoUsuario && $sucessoCliente) {
                ...
                header('Location: /grafica_web/cliente/meusDados.php?status=sucesso&acao=alterado');
            } else {
                header('Location: /grafica_web/cliente/meusDados.php?status=erro&acao=alteracao');
            }
            break;
}
?>